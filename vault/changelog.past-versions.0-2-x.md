...
Note that the new ref syntax expects a [[sluggified|dendron.concepts#slug]] header. This is done automatically when you use the updated [[copy note ref|dendron.ref.commands#copy-note-ref]] command.
